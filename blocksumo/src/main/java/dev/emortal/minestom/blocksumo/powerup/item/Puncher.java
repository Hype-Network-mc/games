...
public final class Puncher extends PowerUp {
    ...
    public void addExtraMetadata(@NotNull ItemStack.Builder builder) {
        builder.set(DataComponents.ENCHANTMENTS, new EnchantmentList(Map.of(Enchantment.KNOCKBACK, 4)));
        builder.itemModel("emortalmc:blocksumo/puncher");
    }

    @Override
    public void onAttack(@NotNull Player attacker, @NotNull Player victim) {
        this.removeOneItemFromPlayer(attacker, PlayerHand.MAIN);
