 ...
 * <p>
 * In order to use it you need to create a new instance using the constructor {@link #Scoreboard(String)} and create new lines
 ...
 */
public final class Scoreboard implements net.minestom.server.scoreboard.Scoreboard {
     ...
     */
    private static final String SCOREBOARD_PREFIX = "emc-sb-";
    private static final String TEAM_PREFIX = "emc-sbt-";
     ...
     * @deprecated Use {@link #Scoreboard(Component)}
     */
    @Deprecated
    public Scoreboard(@NotNull String title) {
     ...
     * @param title The title of the sidebar
     */
    public Scoreboard(@NotNull Component title) {
        this.title = title;
    ...
    @Override
    public @NotNull ScoreboardObjectivePacket getCreationObjectivePacket(Component value, ScoreboardObjectivePacket.Type type) {
        return new ScoreboardObjectivePacket(getObjectiveName(), (byte) 0, value, type, Sidebar.NumberFormat.blank());
    }

    /**
     * Changes the {@link Scoreboard} title
     *
    ...
    public static class ScoreboardLine {
        ...
        public boolean equals(Object obj) {
            if (!(obj instanceof ScoreboardLine o)) return false;
    ...
    /**
     * This class is used to create a team for the {@link Scoreboard}
     */
