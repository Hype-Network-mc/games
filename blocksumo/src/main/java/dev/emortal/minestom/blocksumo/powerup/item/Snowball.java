...
public final class Snowball extends PowerUp {
    ...
    private final class SnowballEntity extends BetterEntityProjectile {
        ...
        public void collidePlayer(@NotNull Point pos, @NotNull Player player) {
            game.sendGroupedPacket(new ParticlePacket(Particle.ITEM_SNOWBALL, pos, Vec.ZERO, 1, 7));

            boolean successful = Snowball.super.game.getPlayerManager().getDamageHandler().damage(player, shooter, false);
