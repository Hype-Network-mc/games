...
public final class GrapplingHook extends PowerUp {
    ...
    void retract(@NotNull Player caster, @NotNull PlayerHand hand) {
    ...
    public void onRetract(@NotNull Player caster, @NotNull PlayerHand hand, @NotNull Pos bobberPos, @Nullable Player hooked) {
