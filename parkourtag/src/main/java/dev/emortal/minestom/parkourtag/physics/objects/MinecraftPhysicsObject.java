...
import static dev.emortal.minestom.parkourtag.utils.CoordinateUtils.*;
...
public abstract class MinecraftPhysicsObject {
    ...
    public void destroy() {
        ...
        // TODO: this causes a crash, however constraints should prob still get removed
        // TODO: unless they already do and that's why it's crashing :P
